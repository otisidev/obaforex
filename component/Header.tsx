            ...
            <nav id="navigation4" className="container navigation">
                ...
                <div className="nav-header">
                    <a href="/" className="nav-brand">
                        <img src="/img/logos/logoWhite.png" className="main-logo" alt="logo" id="light_logo" />
                        <img src="/img/logos/logoMain.png" className="main-logo" alt="logo" id="main_logo" />
                        {/* Toggler */}
                    </a>
                ...
                <div className="nav-menus-wrapper">
                    <ul className="nav-menu align-to-right">
                        ...
                        <li>
                            ...
                            <ul className="nav-dropdown">
                                <li>
                                    <a href="https://app.obaforex.com/">Login</a>
                                </li>
                                <li>
                                    <a href="https://app.obaforex.com/auth/on-boarding/request">Create Account</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="https://app.obaforex.com/auth/on-boarding/request" className="button-sm button-primary btn-slider py-1 mt-2">
                                Apply Now
                            </a>
                        </li>
                        <li>
                            <a href="https://v1.obaforex.com/">
                                <button id="old" className="button-md button-primary" style={{marginTop: "-2em"}}>Visit Old Site</button>
                            </a>
                        </li>
                    </ul>
                </div>
